...
function oriDb() 
{
	...
	$conn['billing_idjkt_t3d'] = oci_connect('ITOS_BILLING', 'itos_BILLING', '10.10.32.25:1521/TO3');
	$conn['billing_idjkt_t2d'] = oci_connect('ITOS_BILLING', 'itos_BILLING', '10.10.32.25:1521/TO2');
	$conn['billing_idjkt_t1d'] = oci_connect('ITOS_BILLING', 'itos_BILLING', '10.10.32.25:1521/TO1');
