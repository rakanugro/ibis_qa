...
function oriDb() 
{
	...
	$conn['container_idjkt_t3d'] = oci_connect('ITOS_REPO', 'ITOS_REPO', '10.10.12.204:1521/TO3');
	$conn['container_idjkt_t2d'] = oci_connect('ITOS_REPO', 'ITOS_REPO', '10.10.12.204:1521/TO2');
	$conn['container_idjkt_t1d'] = oci_connect('ITOS_REPO', 'ITOS_REPO', '10.10.12.204:1521/TO1');
	...
	//$conn['billing_idjkt_t3d'] = oci_connect('ITOS_BILLING', 'itos_billing', '10.10.12.204:1521/TO3');
	//$conn['billing_idjkt_t2d'] = oci_connect('ITOS_BILLING', 'itos_billing', '10.10.12.204:1521/TO2');
	//$conn['billing_idjkt_t1d'] = oci_connect('ITOS_BILLING', 'itos_billing', '10.10.12.204:1521/TO1');
	//$conn['billing_idjkt_itost'] = oci_connect('ITOS_BILLING', 'itos_billing', '192.168.23.44:1521/orcl');
	$conn['ibis'] = oci_connect('IBIS', 'ibis321', '10.10.12.204:1521/ORCL');
