		...
		if($pol=='IDJKT' && $terminal=='009'){
			...
			{	
				...
				*/
				...
				//ambil codeco
				$truck_in_date = null;
				$qContainer1 = "select trim(no_container) no_container,to_char(to_date(TRUCK_IN_DATE,'rrrrmmddhh24miss'),'dd/mm/rrrr hh24:mi:ss') TRUCK_IN_DATE from SIMPB.CODECO_PTP WHERE VESSEL = '$vessel_name' $filterin $filterout";
				//QUERY
				try {
