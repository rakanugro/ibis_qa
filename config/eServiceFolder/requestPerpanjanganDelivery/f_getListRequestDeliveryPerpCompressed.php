...
/*|
 ...
 | EDIT LOG			: 
 |*/
function getListRequestDeliveryPerpCompressed($in_param) {
...
FROM (select 
			...
			where l.customer_id = '$customer_id' and l.kode_modul = 'PTKM07' and status_REQ in ('','N','R') order by l.request_date desc) data_
WHERE rownum <= 100 
ORDER BY rownum";
