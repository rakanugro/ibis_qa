	...
	try {
		...
		if ($row = oci_fetch_array($query_header, OCI_ASSOC))
		{
			...
			<table  border="0" cellspacing="0" cellpadding="0">
				<tr>
				  <td width="408"><div style="font-weight:bold; text-align:left;">Pemberitahuan Kunjungan Kapal (PKK)</div></td>
				</tr>
				<tr>
				  <td>Tanggal cetak : '.$row[TGL_JAM_ENTRY].'</td>
				</tr>
			  </table>
			  <br/>
			  <br/>
			  <table  border="0" cellspacing="0" cellpadding="0">
				<tr>
				  <td width="528" align="center"><h2>Pemberitahuan Kunjungan Kapal (PKK)</h2></td>
				</tr>
			  </table>
			  <br/>
			  <br/>
			  <table  border="0" cellspacing="0" cellpadding="0">
				<tr>
				  <td width="100"><strong>No. PKK</strong></td>
