...
function getRequestDeliveryHeader($in_param) {
	...
	try {
		...
		//get billing info
		//PL/SQL
		$getRequest = "select l.REQUEST_ID, l.BILLER_REQUEST_ID, l.REQUEST_DATE REQUEST_DATE, l.PORT_ID, 
				l.TERMINAL_ID, mt.TERMINAL_NAME, l.STATUS_REQ, l.ADDITIONAL_FIELD1, l.ADDITIONAL_FIELD2, l.ADDITIONAL_DATE, 
				l.VESSEL, l.VOYAGE_OUT, l.VOYAGE_OUT, l.REJECT_NOTES  
			from transaction_log l left join mst_terminal mt on (l.PORT_ID = mt.PORT and l.TERMINAL_ID = mt.TERMINAL) 
			where l.CUSTOMER_ID='$customer_id' and l.kode_modul = 'PTKM01' and status_REQ in ('','N','R') order by l.REQUEST_ID desc";
