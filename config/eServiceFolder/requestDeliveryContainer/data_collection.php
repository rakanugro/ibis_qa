...
function generateResponse($out_data_array, $response_code, $response_message, $msg_format="json",$compressed=0)
{
	...
	{
		if($compressed)
			return base64_encode(gzcompress(json_encode($arr, JSON_HEX_TAG), 9));
		else
