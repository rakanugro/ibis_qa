...
function getRequest($in_param) {
	...
	try {
		...
		$getRequest = "SELECT REQUEST_ID, VESSEL, VOYAGE_IN, VOYAGE_OUT, 
						STATUS_REQ, REQUEST_DATE, PAYMENT_DATE,PORT_ID, 
						TERMINAL_ID, PRF_NUMBER, TRX_NUMBER, MODUL_DESC 
						FROM TRANSACTION_LOG WHERE CUSTOMER_ID='$customer_id' AND STATUS_REQ = 'S' order by request_date desc";
		//return $getRequest;
			//QUERY
