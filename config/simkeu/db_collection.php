...
function oriDb() 
{
	...
	$conn['container_idjkt_t3d'] = oci_connect('ITOS_REPO', 'ITOS_REPO', '192.168.23.44:1521/orcl');
	$conn['container_idjkt_t2d'] = oci_connect('ITOS_REPO', 'ITOS_REPO', '192.168.23.44:1521/orcl');
	$conn['container_idjkt_t1d'] = oci_connect('ITOS_REPO', 'ITOS_REPO', '192.168.23.44:1521/orcl'); 
