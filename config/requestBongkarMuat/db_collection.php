...
function oriDb() 
{
    ...
    /************ DEVELOPMENT *************/
    $conn['barang_idjkt'] = oci_connect('barang_prod', 'barang_prod', '10.10.12.218:1521/peldb');
    //$conn['billing_idjkt_t1'] = oci_connect('ITOS_BILLING', 'itos_billing', '192.168.23.44:1521/orcl');
    // $conn['billing_idjkt_t2'] = oci_connect('ITOS_BILLING', 'itos_billing', '192.168.23.44:1521/orcl');
    // $conn['billing_idjkt_t3'] = oci_connect('ITOS_BILLING', 'itos_billing', '192.168.23.44:1521/orcl');
    
    /************ PRODUCTION *************/
    // $conn['barang_idjkt'] = oci_connect('barang_prod', '$Prod_b4r4ngpass', 'dr-scan.indonesiaport.co.id:1521/PELDBJAL');
    // $conn['billing_idjkt_t1'] = oci_connect('ITOS_BILLING', 'itos_billing', '10.10.12.204:1521/TO1');
    // $conn['billing_idjkt_t2'] = oci_connect('ITOS_BILLING', 'itos_billing', '10.10.12.204:1521/TO2');
    // $conn['billing_idjkt_t3'] = oci_connect('ITOS_BILLING', 'itos_billing', '10.10.12.204:1521/TO3');
