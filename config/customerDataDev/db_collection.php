...
function oriDb()
{
	...
	$conn['kapal'] = oci_connect('JAI_OPIS', 'jai_opis', '10.10.12.214:1521/PELDB');
	$conn['simkeu'] = oci_connect('APPS', 'apps', '10.10.12.253:1527/TEST');//prod
	//$conn['kapal'] = oci_connect('KAPAL_PROD', 'KAPAL_PROD', '10.10.12.204:1521/peldbdev');//dev
	//$conn['simkeu'] = oci_connect('APPS', 'APPS', '10.10.12.253:1521/REDO');//dev
