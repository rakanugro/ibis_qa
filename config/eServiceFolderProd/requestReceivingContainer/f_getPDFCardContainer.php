	...
	try {
		...
		if($terminal_code=='T3I')
		{
			$query_card = "SELECT TO_CHAR (a.CLOSSING_TIME, 'dd/mm/yyyy HH24:MI') CLOSSING_TIME,
                       ...
                       a.BOOKING_NUMB,
                      'CY' STATUS_TL,
					   (SELECT c.SEAL_ID FROM m_cyc_container@dbint_link c 
					    WHERE c.NO_CONTAINER = b.NO_CONTAINER 
							AND c.VESSEL = a.VESSEL 
							AND c.VOYAGE_IN = a.VOYAGE
							AND c.VOYAGE_OUT = a.VOYAGE_OUT) SEAL_ID
			...
			$query_card = "SELECT TO_CHAR (a.CLOSSING_TIME, 'dd/mm/yyyy HH24:MI') CLOSSING_TIME,
                       ...
                       a.BOOKING_NUMB,
                      'CY' STATUS_TL,
					   (SELECT c.SEAL_ID FROM opus_repo.m_cyc_container c 
					    WHERE c.NO_CONTAINER = b.NO_CONTAINER 
							AND c.VESSEL = a.VESSEL 
							AND c.VOYAGE_IN = a.VOYAGE
							AND c.VOYAGE_OUT = a.VOYAGE_OUT) SEAL_ID
		...
		$query_card = "SELECT TO_CHAR (a.CLOSSING_TIME, 'dd/mm/yyyy HH24:MI') CLOSSING_TIME,
					   ...
					   (SELECT c.SEAL_ID FROM itos_repo.m_cyc_container c 
					    WHERE c.NO_CONTAINER = b.NO_CONTAINER 
							AND c.VESSEL = a.VESSEL 
							AND c.VOYAGE_IN = a.VOYAGE
							AND c.VOYAGE_OUT = a.VOYAGE_OUT) SEAL_ID
