...
function getCountStatusNotaArReceipt($in_param) {
	...
	try {
		...
		{
			//QUERY
			if(!checkOriSQL($conn['ori']['keu_prod'],$query[$i]['query_count_allnota'],$query_result_all,$err)) goto Err;
			if(!checkOriSQL($conn['ori']['keu_prod'],$query[$i]['query_count_arnotfound'],$query_result_arnotfound,$err)) goto Err;
			if(!checkOriSQL($conn['ori']['keu_prod'],$query[$i]['query_count_receiptnotfound'],$query_result_receiptnotfound,$err)) goto Err;
			if(!checkOriSQL($conn['ori']['keu_prod'],$query[$i]['query_count_overpayment'],$query_result_overpayment,$err)) goto Err;
