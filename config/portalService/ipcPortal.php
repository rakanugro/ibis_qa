...
function getReckonPLP($awal,$akhir,$channel) {
    ...
    // db connection
   if ($conn = oci_connect('BILLING_OBX', 'billing_OBX', '10.10.32.25/orcl')) {
...
*/
      ...
      if(($chn=='H2H')||($chn=='EDC'))
      {
			...
			while ($row = oci_fetch_array($query2, OCI_ASSOC))
			{
				...
				{	
					// db connection
					if ($conn2 = oci_connect('ITOS_OP', 'itos_OP', '10.10.32.25/to3')) {
				...
				{
					// db connection
					if ($conn2 = oci_connect('ITOS_OP', 'itos_OP', '10.10.32.25/to2')) {
				...
				{
					// db connection
					if ($conn2 = oci_connect('ITOS_OP', 'itos_OP', '10.10.32.25/to1')) {
