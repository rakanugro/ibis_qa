				...
				<div class="main-box clearfix">
					...
					<div class="form-group example-twitter-oss">
						...
						<select class="form-control" id="terminal" name="terminal">
							...
							<?php foreach($terminal as $terminals){ ?>
								<option value="<?php echo $terminals->terminal_code ?>"><?php echo $terminals->terminal_name ?></option>
							<?php } ?>
						</select>
					</div>
					<div class="form-group example-twitter-oss">
					...
					<div class="main-box-body clearfix">
						<div class="panel-group" id="accordion">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse1" style="color:white">Gate In</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse2" style="color:white">Placement</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse3" style="color:white">Stevedoring (Muat)</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse4" style="color:white">Stevedoring (Bongkar)</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse5" style="color:white">Placement</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse6" style="color:white">Gate Out</a>
									</h4>
								</div>
	...
	$.ajax({
		...
		success:function(data) {
				...
				if (obj_detail_bl instanceof Array) {
				  	for(var i = 0; i < obj_detail_bl.length; i++){
				  		tablebl.row.add(
				  			$('<tr>' +
				  				...
				  				'<td>' + obj_detail_bl[i]['_c']['weightRealization']['_v'] + '</td>' +
				  				'<td>' + obj_detail_bl[i]['_c']['vesselName']['_v'] + '</td>' +
				  				'<td>' + obj_detail_bl[i]['_c']['blCustName']['_v'] + '</td>' +
				  				'<td>' + obj_detail_bl[i]['_c']['trade']['_v'] + '</td>' +
				  			'<tr>')
				  		).draw();
				  	}
				} else {
				  	tablebl.row.add(
			  			$('<tr>' +
			  				...
			  				'<td>' + obj_detail_bl['_c']['trade']['_v'] + '</td>' +
			  			'<tr>')
			  		).draw();
				}
			...
			for (var ac = 0; ac < obj_activity.length; ac++){
				if ((obj_activity[ac]['_c']['statusStevedoring']['_v']).toUpperCase() == 'BONGKAR'){
					$('#muat_gate_in').html(obj_activity[ac]['_c']['gateIn']['_v']);
					$('#muat_truck_number').html(obj_activity[ac]['_c']['truckNumber']['_v']);
					$('#muat_placement_date').html(obj_activity[ac]['_c']['truckInDate']['_v']);
					$('#muat_location').html(obj_activity[ac]['_c']['idTerminal']['_v']);
					$('#stevedoring_muat_date').html(obj_activity[ac]['_c']['stevedoringDate']['_v']);
					// $('#stevedoring_muat_location').html(obj_activity[ac]['_c']['statusStevedoring']['_v']);
					$('#stevedoring_muat_to_vessel').html(obj_activity[ac]['_c']['vesselName']['_v']);
				}else if ((obj_activity[ac]['_c']['statusStevedoring']['_v']).toUpperCase() == 'MUAT'){
					$('#stevedoring_bongkar_date').html(obj_activity[ac]['_c']['stevedoringDate']['_v']);
					// $('#stevedoring_bongkar_location').html(obj_activity[ac]['_c']['statusStevedoring']['_v']);
					$('#stevedoring_bongkar_from_vessel').html(obj_activity[ac]['_c']['vesselName']['_v']);
					$('#bongkar_placement_date').html(obj_activity[ac]['_c']['truckInDate']['_v']);
					$('#bongkar_location').html(obj_activity[ac]['_c']['idTerminal']['_v']);
					$('#bongkar_gate_out').html(obj_activity[ac]['_c']['gateIn']['_v']);
