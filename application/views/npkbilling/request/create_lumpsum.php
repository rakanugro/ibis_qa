		...
		<div class="main-box">
			...
			<div class="main-box-body clearfix">
				...
				<div class="form-group col-xs-6">
					...
					<input name="LUMPS_CONTRACT_NO" id="LUMPS_CONTRACT_NO" type="text" class="form-control" placeholder="Autocomplete">
				</div>
				<div class="form-group col-xs-6">
...
<script>
	...
	function lumpsum_log(no_req){
		$.ajax({
			url: "<?=ROOT?>npkbilling/transaction_log/lumpsum_insert_log",
			type: 'POST',
			//dataType: 'json',
			data: {
				'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
