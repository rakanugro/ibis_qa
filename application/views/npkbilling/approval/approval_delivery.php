	...
	$(document).ready(function() {
		...
		$.ajax({
		    type: "GET",
		   	...
		   	url: "<?=ROOT?>npkbilling/approval_delivery/getListApprovalDelivery",
	    	data: {},  // <== change is here
		    success: function(data){
	            ...
	            for(i=0;i<jmlresponse;i++)
				{
					...
					var del_status				=obj['result'][i]['del_status'];
				    ...
				    table.append(
				       '<tr>' +
						    ...
						    '<td>'+
								...
								'<a class=\'btn btn-primary\'  href="<?=ROOT?>npkbilling/approval_delivery/preview_approval_delivery?id='+abc.del_id+'" ><span class="glyphicon glyphicon-pencil"></span></a>'+ "&nbsp"+"&nbsp"+"&nbsp"+
							'</td>'+
						'</tr>'
			        );
