			...
			<div class="main-box clearfix">
				...
				<div class="main-box-body clearfix">
					<div class="form-group example-twitter-oss">
						...
						<input type="text" class="form-control" id="DEL_ID" name="request_id"  placeholder="Request ID">
					</div>
					<div class="form-group example-twitter-oss">
					...
					<div class='col-lg-6'>
						...
						<input type="text" class="form-control" id="DEL_TERMINAL_NAME" name="terminal_name"  placeholder="Customer">
					</div>				
					<div class='col-lg-6'>
					...
					<div class='col-lg-6'>
						...
						<input type="text" class="form-control" id="DEL_TRADE_NAME" name="trade_name"  placeholder="nomor request">
					</div>			
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function save_approval(action, remarks)
	{
		...
		var urlaction = "";
		if (action == 'approve'){
			urlaction = "<?php echo ROOT ?>npkbilling/approval_extension/ApprovalNow/<?php echo $id_param; ?>";
		}else{
			urlaction = "<?php echo ROOT ?>npkbilling/approval_extension/RejectNow/<?php echo $id_param; ?>";
		}
		if (action == 'approve'){
					...
					$.ajax({
						...
						success: function(data) {
							...
							if (array_data['Success'] == undefined) {
								...
								setTimeout(function(){ window.location = "<?=ROOT?>npkbilling/approval_extension"; }, 1000);	
							} else {
...
$.ajax({
      ...
      url: "<?=ROOT?>npkbilling/approval_extension/get_viewuper?id="+<?php echo $id_param;?>,
      type: "GET",
      dataType : 'json',
      success: function (data) {
      	//console.log(data)
