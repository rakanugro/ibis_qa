                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="box-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-5">
                                                        <input type="text" name="TRX_NUMBER" id="TRX_NUMBER" class="form-control" placeholder="Nomor Nota">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        path = "<?php echo ROOT.'einvoice/nota_cabang/ustersearch';?>";
        panjang = 20;
        data    = 0;
        if(data==1){
        ...
        tableUster = $('#dttable').DataTable({
            ...
            "columns": [
                ...
                { "data": "TRX_NUMBER" },
                { "data": "VESSEL_NAME" },
                { "data": "INTERFACE_HEADER_ATTRIBUTE10" },
                { "data": "JENIS_NOTA_DISP" },
                { "data": "TGL_NOTA" },
                { "data": "jumlah" },
                { "data": "STATUS_LUNAS" },
                { "data": "action2" },
