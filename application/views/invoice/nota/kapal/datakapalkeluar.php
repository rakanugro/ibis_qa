	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="height:500px; ">
				...
				<input type="text" id="org_ready" value="" class="hidden">
				<input type="text" id="jamtiba_ready" value="" class="hidden">
				<input type="text" id="jamberangkat_ready" value="" class="hidden">
...
$("#search_form").on('submit',(function(e) {
  ...
  $(document).on('click','.btn-ok',function(e){
                 ...
                 var jamberangkat = $(this).attr('data-jamberangkat');
                ...
                jQuery.ajax({
                 ...
                 jQuery.ajax({
	           		...
	           		url: '<?php echo ROOT;?>dashboard_invoice/cetak_dpjk/'+ukk+'/'+cab+'/'+ppkb+'/'+org+'/'+jamtiba+'/'+jamberangkat,
	                type: "POST",
		               data: {
		               	'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
	                  	NO_UKK:ukk,
	                  	...
	                  	KD_PPKB:ppkb,
	                  	ORG_ID:org,
	                  	TGL_JAM_TIBA:jamtiba,
	                  	TGL_JAM_BERANGKAT:jamberangkat
	                  },
	                ...
	                success:function(data){
	                	$('.text-help').text(ukk);
						var url ='<?php echo ROOT;?>dashboard_invoice/cetak_dpjk/'+ukk+'/'+cab+'/'+ppkb+'/'+org+'/'+jamtiba+'/'+jamberangkat;
	                	$('.text-me').html('<iframe  class="the_pdf" style="height: 100%;width:100%;"  src= "'+url+'" /></iframe>')
						$('#ukk_ready').val(ukk);
						$('#cab_ready').val(cab);
						$('#ppkb_ready').val(ppkb);
						$('#org_ready').val(org);
						$('#jamtiba_ready').val(jamtiba);
						$('#jamberangkat_ready').val(jamberangkat);
...
var org_ready = $('#cab_ready').val();
var jamtiba_ready = $('#ppkb_ready').val();
var jamberangkat_ready = $('#jamberangkat_ready').val();
