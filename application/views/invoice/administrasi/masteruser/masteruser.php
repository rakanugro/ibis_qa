		...
		<div class="modal-content">
	        ...
	        <div class="modal-body">
				...
				<div class="tab-pane fade in active" id="tab-home">
					...
					<input type="hidden" name="INV_USER_ENTITY3" id="INV_USER_ENTITY3">
						<div class="box-body">
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Nama</label>
								<div class="row">
...
$('.btn_user_update').click(function(){
	...
	$('#form_update').validator().on('submit', function (e) {
		...
		var INV_ROLE_NAME = $("#INV_USER_ENTITY3").val();
 ...
 //        return false;
	...
	function edituser($id)
	{
			...
			for(i=0; i<Object.keys(data1).length; i++){
                ...
                $('[name="INV_USER_ENTITY3"]').val(data1[i].INV_ROLE_NAME);
	...
	function saveuserrole()
	{
		...
		var INV_ROLE_NAME_X = $("#INV_ROLE_NAME1 option:selected").text();
