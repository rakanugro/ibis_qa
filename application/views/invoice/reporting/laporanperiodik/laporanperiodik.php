				...
				<div class="box-body">
					<div class="row">
                          ...
                          <div class="input-group">
                            <input type="date" name="TGL_PELUNASAN_START" id="TGL_PELUNASAN_START" class="form-control form_datetime" placeholder="dd/mm/yy">

                          </div>
												</div>
												<div class="col-xs-4">
                          <div class="input-group">
                            <input type="date" name="TGL_PELUNASAN_END" id="TGL_PELUNASAN_END" class="form-control form_datetime" placeholder="dd/mm/yy">
					      	...
					      	<div class="col-md-12">
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" value="" id="no_nota" checked onclick="return false;">No Nota
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='layanan' value="">Layanan
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='ppn' value="">PPN
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='tanggal_lunas' value="">Tanggal Lunas
									  </label>
					      		</div>
			  				...
			  				<div class="col-md-12">
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='tanggal_nota' value="" checked onclick="return false;">Tanggal Nota
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='jenis_nota' value="">Jenis Nota
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
					      		...
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='bank' value="" >Bank
									  </label>
					      		</div>
			  				...
			  				<div class="col-md-12">
					      		...
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='no_pajak' value="">No Pajak
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='status_transfer' value="">Status Transfer
									  </label>
					      		</div>
			  				...
			  				<div class="col-md-12">
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='currency' value="">Currency
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id='pendapatan' value="" checked onclick="return false;">Pendapatan
									  </label>
					      		</div>
					      		<div class="col-md-3">
									 <label class="checkbox-inline">
									      <input type="checkbox" id="status_lunas" value="">Status Lunas
									  </label>
					      		</div>
...
<script>
	...
	function loaddata(){
		...
		/*var path2 = '';
		path2 = "<?php echo ROOT.'einvoice/nota/periodikfilter';?>";
		...
		/*$user['datauser'] = $this->session->all_userdata();
		print_r($user);die();*/
...
<script type="text/javascript">
	...
	var tanggal_nota = $("#tanggal_nota").is(":checked") ? true : false;
	var customer = $("#customer").is(":checked") ? true : false;
	...
	var no_pajak = $("#no_pajak").is(":checked") ? true : false;
	var status_transfer = $("#status_transfer").is(":checked") ? true : false;
	var status_lunas = $("#status_lunas").is(":checked") ? true : false;
	...
	var status_lunas = $("#status_lunas").is(":checked") ? true : false;
    //console.log(status_lunas)
    
	window.open('<?php echo ROOT.'einvoice/reporting/cetak_laporanperiodik_excel';?>?'
		+"CUSTOMER_NAME="+CUSTOMER_NAME+"&"
		+"INV_NOTA_JENIS="+INV_NOTA_JENIS+"&"
		+"HEADER_CONTEXT="+HEADER_CONTEXT+"&"
		+"STATUS_LUNAS="+STATUS_LUNAS+"&"
		+"TGL_PELUNASAN_START="+TGL_PELUNASAN_START+"&"
		+"TGL_PELUNASAN_END="+TGL_PELUNASAN_END+"&"
	...
	var status_lunas = $("#status_lunas").is(":checked") ? true : false;
		window.open('<?php echo ROOT.'einvoice/reporting/cetak_laporanperiodik';?>?'
		+"CUSTOMER_NAME="+CUSTOMER_NAME+"&"
		+"INV_NOTA_JENIS="+INV_NOTA_JENIS+"&"
		+"HEADER_CONTEXT="+HEADER_CONTEXT+"&"
		+"STATUS_LUNAS="+STATUS_LUNAS+"&"
