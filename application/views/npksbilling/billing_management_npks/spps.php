	...
	<div class="col-lg-12">
		<div class="main-box clearfix">
			<header class="main-box-header clearfix">
				<h2 class="pull-left">SPPS List</h2>
			</header>
...
<script>
	...
	$(document).ready(function() {
		...
		$.ajax({
			type: "GET",
			url: "<?= ROOT ?>npksbilling/spps/getListSpps?",
			data: {},
			success: function(data) {
				...
				// 	var nota_proforma_no = obj['result'][i]['nota_proforma_no'];
				// 	var nota_cust_name = obj['result'][i]['nota_cust_name'];
				// 	var nota_req_date = obj['result'][i]['nota_req_date'];
				// 	var reff_name = obj['result'][i]['nota_cust_name'];
				// }
				var nomor = 1;
				obj['result'].forEach(function(abc) {
					if (abc.nota == "4" || abc.nota == "10" || abc.nota == "11" || abc.nota == "12" || abc.nota == "18") {
						var status = "STRIPPING";
					} else if (abc.nota == "17" || abc.nota == "3" || abc.nota == "7" || abc.nota == "8" || abc.nota == "9") {
						var status = "STUFFING";
					}
					table.append(
						'<tr>' +
