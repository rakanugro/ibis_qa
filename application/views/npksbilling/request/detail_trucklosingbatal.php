...
<script>
	...
	$.ajax({
      ...
      url: "<?=ROOT?>npksbilling/trucklosingbatal/preview/"+id_param,
      type: "GET",
      dataType : 'json',
      success: function (data) {
        ...
        console.log(data);
        				...
        				var req_method = (data['HEADER_REQ'][0]['tl_paymethod'] != 2)? "PIUTANG" : "ADVANCED PAYMENT";
						var req_to = '';
						if ((data['HEADER_REQ'][0]['tl_from'] == 1)){
							req_to = "DEPO";
						}else if((data['HEADER_REQ'][0]['tl_from'] == 2)){
							req_to = "TPK";
						}else{
							req_to = "TONGKANG";
						}
