...
<!-- <div class="row">
	<div class="col-lg-12 ">
		<div class="main-box">
			...
			<input id="Dfumi_ID" name="Dfumi_ID" type="hidden" class="form-control">
			<div class="main-box-body clearfix">
				<div class="form-group col-xs-4">
					<label>No Container</label>
					<input name="Dfumi_NO_CONTAINER" id="Dfumi_NO_CONTAINER" type="text" class="form-control" placeholder="No Container" required="">
				</div>
				<div class="form-group col-xs-4">
					<label>Status</label>
					<select id="Dfumi_STATUS" name="Dfumi_STATUS" class="form-control" required="">
						<option value="not-selected"> -- Please Choose Status  -- </option>
					</select>
				</div>
				<div class="form-group col-xs-4">
					<label>Via</label>
					<select id="Dfumi_VIA" name="Dfumi_VIA" class="form-control" required="">
						<option value="not-selected"> -- Please Choose Via  -- </option>
					</select>
				</div>
				<div class="form-group col-xs-4">
					<label>Ukuran</label>
					<select id="Dfumi_UKURAN" name="Dfumi_UKURAN" class="form-control" required="">
						<option value="not-selected"> -- Please Choose Ukuran  -- </option>
					</select>
				</div>
				<div class="form-group col-xs-4">
					<label>Sifat</label>
					<select id="Dfumi_SIFAT" name="Dfumi_SIFAT" class="form-control" required="">
				...
				<div class="form-group col-xs-4">
					...
					<div class="input-group">
						...
						<input id="Dfumi_TGL_RCV" name="Dfumi_TGL_RCV" type="text" class="form-control" value="<?=date('m/d/Y')?>" required="" readOnly>
					</div>
				</div>
				<div class="form-group col-xs-4">
					<label>Type</label>
					<select id="Dfumi_TYPE" name="Dfumi_TYPE" class="form-control" required="">
						<option value="not-selected"> -- Please Choose Type  -- </option>
					</select>
				</div>
				<div class="form-group col-xs-4">
					<label>Komoditi</label>
					<select id="Dfumi_KOMODITI" name="Dfumi_KOMODITI" class="form-control" required="">
						<option value="not-selected"> -- Please Choose Komoditi  -- </option>
					</select>
				</div>
				<div class="form-group col-xs-4">
					<label>Container Owner</label>
					<input name="Dfumi_CONTAINER_OWNER" id="Dfumi_CONTAINER_OWNER" type="text" class="form-control" placeholder="Autocomplete" required="">
				</div>
...
<script>
	...
	$.ajax({
      ...
      url: "<?=ROOT?>npksbilling/fumigasibatal/preview/"+id_param,
      type: "GET",
      dataType : 'json',
      success: function (data) {
        ...
        console.log(data);
        				...
        				var req_method = (data['HEADER_REQ'][0]['fumi_paymethod'] != 2)? "PIUTANG" : "ADVANCED PAYMENT";
						var req_to = '';
						if ((data['HEADER_REQ'][0]['fumi_from'] == 1)){
							req_to = "DEPO";
						}else if((data['HEADER_REQ'][0]['fumi_from'] == 2)){
							req_to = "TPK";
						}else{
							req_to = "TONGKANG";
						}
						...
						$('#from').val(data['HEADER_REQ'][0]['fumi_from']);
		        	...
		        	//console.log(row);
						...
						// DETAILS
						  ...
						  var no = 1;
							...
							//if(abc.fumi_dfumi_iscancelled === "Y" ) document.getElementById("chk").checked == true;
