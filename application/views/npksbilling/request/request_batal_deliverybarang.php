		...
		<div class="col-lg-12">
			<div class="main-box">
				<header class="main-box-header clearfix">
					<h2>Create New</h2>
                        <i>(Please click create to make a new Batal Delivery Barang)</i>
				</header>
										
				<div class="main-box-body clearfix">
					<form class="form-inline" role="form" action="<?=ROOT?>npksbilling/deliverybarangbatal/create_deliverybarangbatal">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="main-box clearfix">
				<header class="main-box-header clearfix">
					<h2 class="pull-left">List Batal Delivery Barang</h2>
				</header>
	...
	$(document).ready(function() {
		...
		$.ajax({
		    type: "GET",
		   	...
		   	url: "<?=ROOT?>npksbilling/deliverybarangbatal/getlistdeliverybarangbatal",
	    	data: {},  // <== change is here
				...
				obj['result'].forEach(function(abc) {
				    ...
				    table.append(
				       '<tr>' +
						    ...
						    '<td>'+ abc.del_cargo_cust_name +'</td>' +
						    '<td>'+ abc.del_cargo_vessel_name +'</td>' +
						    ...
						    '<td>'+
						    	...
						    	'<a class=\'btn btn-danger\'  href="<?=ROOT?>npksbilling/deliverybarangbatal/view/'+abc.cancelled_id+'" ><span class="glyphicon glyphicon-list-alt"></span></a>'+"&nbsp"+"&nbsp"+"&nbsp"+ 
								'<a class="btn btn-primary '+status+'"  href="<?=ROOT?>npksbilling/deliverybarangbatal/edit_deliverybarangbatal/'+abc.cancelled_id+'" ><span class="glyphicon glyphicon-edit"></span></a>'+
...
$(document).on("click", ".open-AddBookDialog", function () {
		...
		function send(id){
			...
			$.ajax({
				type: "GET",
				url: "<?=ROOT?>npksbilling/deliverybarangbatal/send/"+id,
				success: function(data){
					$.unblockUI();
					...
					if(json.success == "S"){
						...
						if(resp.Success == true){
							...
							window.location = "<?=ROOT?>npksbilling/deliverybarangbatal";
						}
						else{
