...
<script>
	...
	$('#request_id_reff').autocomplete({
			source: function( request, response ) {
				$.ajax({
					url: "<?=ROOT?>npksbilling/deliverycontainerbatal/get_nomor_request",
					type: 'GET',
					dataType: "json",
					data: {
						search: request.term
			...
			select: function (event, ui) {
				...
				$.ajax({
					url: "<?=ROOT?>npksbilling/deliverycontainerbatal/auto_generate_by_noreq",
					type: 'GET',
					dataType: "json",
					data: {
					...
					success: function( data ) {
						...
						$('#pbm').val(data['HEADER'][0]['del_pbm_name']);
						
						$('#to').val(req_to);
						$('#penumpukan_oleh').val(data['HEADER'][0]['del_stackby_name']);
						$('#payment_method').val(req_method);

						//customer
						$('#del_cust_name').val(data['HEADER'][0]['del_cust_name']);
						$('#del_cust_npwp').val(data['HEADER'][0]['del_cust_npwp']);
						$('#del_cust_address').val(data['HEADER'][0]['del_cust_address']);
						

											
						// VESSEL
						$('#vessel').val(data['HEADER'][0]['del_vessel_name']);
						$('#nama_agen').val(data['HEADER'][0]['del_vessel_agent_name']);
						$('#no_pkk').val(data['HEADER'][0]['del_vessel_pkk']);
						$('#voyage_in').val(data['HEADER'][0]['del_voyin']);
						$('#voyage_out').val(data['HEADER'][0]['del_voyout']);
						$('#port_of_loading').val(data['HEADER'][0]['del_vessel_pol']);
						$('#port_of_destination').val(data['HEADER'][0]['del_vessel_pod']);
