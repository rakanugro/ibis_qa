...
<script>
	...
	$(document).ready(function() {
		...
		$.ajax({
		    type: "GET",
		   	url: "<?=ROOT?>npksbilling/deliverycontainerext/getDataReq?extension_id="+ extension_id,
	...
	function save_extension() {
		...
		$('#detail-list tbody tr').each(function(){
			...
			var temp = {
				"DEL_DTL_ID": $(this).find('.TBL_DTL_ID').html(),
                "DEL_HDR_ID": $(this).find('.TBL_HDR_ID').html(),
