...
<script>
	...
	$('#request_id_reff').autocomplete({
			source: function( request, response ) {
				$.ajax({
					url: "<?=ROOT?>npksbilling/fumigasibatal/get_nomor_request",
					type: 'GET',
					dataType: "json",
					data: {
						search: request.term
			...
			select: function (event, ui) {
				...
				$.ajax({
					url: "<?=ROOT?>npksbilling/fumigasibatal/auto_generate_by_noreq",
					type: 'GET',
					dataType: "json",
					data: {
					...
					success: function( data ) {
						...
						$('#fumi_branch_id').val(data['HEADER'][0]['fumi_branch_id']);
						$('#fumi_branch_code').val(data['HEADER'][0]['fumi_branch_code']);

						$('#pbm').val(data['HEADER'][0]['fumi_pbm_name']);
						
						$('#from').val(req_to);
						$('#penumpukan_dari').val(data['HEADER'][0]['fumi_stackby_name']);
						$('#payment_method').val(req_method);
						$('#receiving_from').val(data['HEADER'][0]['fumi_paymethod']);

						//customer
						$('#fumi_cust_name').val(data['HEADER'][0]['fumi_cust_name']);
						$('#fumi_cust_npwp').val(data['HEADER'][0]['fumi_cust_npwp']);
						$('#fumi_cust_address').val(data['HEADER'][0]['fumi_cust_address']);
						

											
						// VESSEL
						$('#vessel').val(data['HEADER'][0]['fumi_vessel_name']);
						$('#nama_agen').val(data['HEADER'][0]['fumi_vessel_agent_name']);
						$('#no_pkk').val(data['HEADER'][0]['fumi_vessel_pkk']);
						$('#voyage_in').val(data['HEADER'][0]['fumi_voyin']);
						$('#voyage_out').val(data['HEADER'][0]['fumi_voyout']);
						$('#port_of_loading').val(data['HEADER'][0]['fumi_pol']);
						$('#port_of_destination').val(data['HEADER'][0]['fumi_pod']);
