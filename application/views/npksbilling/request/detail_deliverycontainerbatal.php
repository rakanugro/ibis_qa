...
<div class="row">
	<div class="col-lg-12">
		<div class="main-box">
			<header></header> class="main-box-header clearfix">
...
<script>
	...
	$.ajax({
      ...
      url: "<?=ROOT?>npksbilling/deliverycontainerbatal/preview/"+id_param,
      type: "GET",
      dataType : 'json',
      success: function (data) {
        ...
        console.log(data);
        				...
        				var req_method = (data['HEADER_REQ'][0]['del_paymethod'] != 2)? "PIUTANG" : "ADVANCED PAYMENT";
						var req_to = '';
						if ((data['HEADER_REQ'][0]['del_from'] == 1)){
							req_to = "DEPO";
						}else if((data['HEADER_REQ'][0]['del_from'] == 2)){
							req_to = "TPK";
						}else{
							req_to = "TONGKANG";
						}
		        	...
		        	//console.log(row);
						...
						// DETAILS
						  ...
						  var no = 1;
							...
							//if(del_dtl_iscancelled ==="Y" ) $('#chk').attr("checked",flag);
							$('#detail-list tbody').append(
								'<tr>' +
									'<td>'+ no++ +'</td>' +
									'<td>'+ abc.del_dtl_cont +'</td>' +
									'<td>'+ abc.del_dtl_size+'</td>' +
