		...
		<div class="main-box">
			...
			<div class="main-box-body clearfix">
				<div class="form-group col-xs-12">
					...
					<input name="del_cargo_cust_name" id="del_cargo_cust_name" type="text" class="form-control" placeholder="Autocomplete" required="" required="">
				</div>
				<div class="form-group col-xs-12">
					<label>NPWP</label>
					<input name="del_cargo_cust_npwp" id="del_cargo_cust_npwp" type="text" class="form-control" placeholder="Auto Generate" required="" readonly="">
				</div>
				<div class="form-group col-xs-12">
					<label>Alamat</label>
					<input name="del_cargo_cust_address" id="del_cargo_cust_address" type="text" class="form-control" placeholder="Autocomplete" required="" readonly="">
				</div>
...
<script>
	            ...
	            if ($('#del_cargotxt'+i).val() >0) {  
					...
					var temp = {
						"CANCL_HDR_ID": $('#cancelled_id' + i).val(),
			 			"CANCL_DTL_ID": $('#del_cargo_dtl_id' + i).val(),
	...
	$.ajax({
      ...
      url: "<?=ROOT?>npksbilling/deliverybarangbatal/preview_edit/"+id_param,
      type: "GET",
      dataType : 'json',
      success: function (data) {
      	//console.log(data);
        ...
        console.log(data);
        				...
        				$('#cancelled_id').val(data["HEADER"][0]['cancelled_id']);
       					...
       					$('#request_id_reff').val(data["HEADER"][0]['del_cargo_no']);
						...
						//customer
						$('#del_cargo_cust_name').val(data['HEADER'][0]['del_cargo_cust_name']);
						$('#del_cargo_cust_npwp').val(data['HEADER'][0]['del_cargo_cust_npwp']);
						$('#del_cargo_cust_address').val(data['HEADER'][0]['del_cargo_cust_address']);
						...
						$('#port_of_loading').val(data['HEADER'][0]['del_cargo_vessel_pol']);
						$('#port_of_destination').val(data['HEADER'][0]['del_cargo_vessel_pod']);
		        	...
		        	//console.log(row);
						...
						// DETAILS
						  ...
						  var no = 1;
							...
							//if(abc.del_cargo_dtl_iscancelled === "Y" ) document.getElementById("chk").checked == true;
							...
							$('#detail-list tbody').append(
								'<tr>' +
									...
									'<td>'+ abc.del_cargo_dtl_via+'</td>' +
									'<td>'+ abc.del_cargo_dtl_del_date+'</td>' +
									
									'<td>' +
										'<input type="text" name="name1" id="del_cargotxt'+i+'" value="'+abc.cancl_qty+'"/>' +
