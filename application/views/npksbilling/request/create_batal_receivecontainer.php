		...
		<div class="main-box">
			...
			<div class="main-box-body clearfix">
				...
				<div class="form-group col-xs-6">
					...
					<input name="rec_branch_code" id="rec_branch_code" type="hidden" class="form-control" placeholder="rec_branch_id" required="" readonly="">
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	$('#request_id_reff').autocomplete({
			source: function( request, response ) {
				$.ajax({
					url: "<?=ROOT?>npksbilling/receivecontainerbatal/get_nomor_request",
					type: 'GET',
					dataType: "json",
					data: {
						search: request.term
			...
			select: function (event, ui) {
				...
				$.ajax({
					url: "<?=ROOT?>npksbilling/receivecontainerbatal/auto_generate_by_noreq",
					type: 'GET',
					dataType: "json",
					data: {
					...
					success: function( data ) {
						...
						$('#rec_branch_id').val(data['HEADER'][0]['rec_branch_id']);
						$('#rec_branch_code').val(data['HEADER'][0]['rec_branch_code']);
						$('#pbm').val(data['HEADER'][0]['rec_pbm_name']);
						
						$('#from').val(req_to);
						$('#penumpukan_oleh').val(data['HEADER'][0]['rec_stackby_name']);
						$('#payment_method').val(req_method);

						//customer
						$('#rec_cust_name').val(data['HEADER'][0]['rec_cust_name']);
						$('#rec_cust_npwp').val(data['HEADER'][0]['rec_cust_npwp']);
						$('#rec_cust_address').val(data['HEADER'][0]['rec_cust_address']);
						

											
						// VESSEL
						$('#vessel').val(data['HEADER'][0]['rec_vessel_name']);
						$('#nama_agen').val(data['HEADER'][0]['rec_vessel_agent_name']);
						$('#no_pkk').val(data['HEADER'][0]['rec_vessel_pkk']);
						$('#voyage_in').val(data['HEADER'][0]['rec_voyin']);
						$('#voyage_out').val(data['HEADER'][0]['rec_voyout']);
						$('#port_of_loading').val(data['HEADER'][0]['rec_vessel_pol']);
						$('#port_of_destination').val(data['HEADER'][0]['rec_vessel_pod']);
