	...
	<div class="col-lg-12">
		<div class="main-box clearfix">
			<header class="main-box-header clearfix">
				<h2 class="pull-left">List - Approval Delivery Container</h2>
			</header>
...
<script>
	$(document).ready(function() {
		...
		$.ajax({
			type: "GET",
			url: "<?= ROOT ?>npksbilling/appbookdel/getList?",
			data: {},
			success: function(data) {
				...
				obj.result.forEach(function(del) {
					table.append(
						...
						//'<td>'+ mark +'</td>' +
						'<td>' +
						'<a class="btn btn-primary" href="<?= ROOT ?>npksbilling/appbookdel/preview/' + del.del_id + '" title="Preview"><span class="glyphicon glyphicon-list-alt"></span></a>' + "&nbsp" + "&nbsp" +
						'</td>' +
						'</tr>'
					);
