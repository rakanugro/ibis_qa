...
<script>
	...
	$.ajax({
		...
		type: "GET",
		url: "<?=ROOT?>npksbilling/approveextstripping/preview/<?=$id ?>",
	...
	$.ajax({
      	...
      	url: "<?=ROOT?>npksbilling/approveextstripping/preview_uper/<?=$id?>",
      	type: "GET",
      	dataType : 'json',
      	success: function (data) {
	...
	function save_approval(action, remarks)
	{
		...
		if (action == 'approve'){
			...
			$.ajax({
				type: "GET",
				url: "<?=ROOT?>npksbilling/approveextstripping/approve/<?=$id?>",
				success: function(data){
					$.unblockUI();
					...
					if(json.success == "S"){
						...
						if(resp.no_req != "" || resp.no_req != undefined){
							...
							window.location = "<?=ROOT?>npksbilling/approveextstripping";
						}
						else{
			...
			$.ajax({
				type: "POST",
				url: "<?=ROOT?>npksbilling/approveextstripping/reject/<?=$id?>",
				data: {
