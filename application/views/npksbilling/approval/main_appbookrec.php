...
<script>
	$(document).ready(function() {
		...
		$.ajax({
		    type: "GET",
		   	url: "<?=ROOT?>npksbilling/appbookrec/getList?",
	    	data: {},
				...
				obj.result.forEach(function(rec) {
				    ...
				    table.append(
				       '<tr>' +
						    ...
						    '<td>'+ mark +'</td>' +
							'<td>'+
								'<a class="btn btn-danger" href="<?=ROOT?>npksbilling/appbookrec/view/'+rec.rec_id +'"><span class="glyphicon glyphicon-list-alt"></span></a>'+ "&nbsp"+"&nbsp"+
						'</tr>'
			        );
