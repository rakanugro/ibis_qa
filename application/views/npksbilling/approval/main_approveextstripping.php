		...
		<div class="col-lg-12">
			<div class="main-box">
				<header class="main-box-header clearfix">
					<h2>Create New</h2>
                        <i>(Please click create to make a new Approval Extention stripping)</i>
				</header>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="main-box clearfix">
				<header class="main-box-header clearfix">
					<h2 class="pull-left">List Approval Extention stripping</h2>
				</header>
...
<script>
	$(document).ready(function() {
		...
		$.ajax({
		    type: "GET",
		   	url: "<?=ROOT?>npksbilling/approveextstripping/getList?",
	    	data: {},
		    success: function(data){
				...
				obj.result.forEach(function(rec) {
					...
					var status = (rec.stripp_status == 3 || rec.stripp_status == 2)? "disabled" : "";
				    ...
				    table.append(
				       '<tr>' +
						    ...
						    '<td>'+ mark +'</td>' +
							'<td>'+
								'<a class="btn btn-danger" href="<?=ROOT?>npksbilling/approveextstripping/view/'+rec.stripp_id +'"><span class="glyphicon glyphicon-list-alt"></span></a>'+ "&nbsp"+"&nbsp"+
							'</td>'+
						'</tr>'
			        );
