	...
	<div class="row">
		<div class="col-lg-12">
			<div class="main-box clearfix">
				<header class="main-box-header clearfix">
					<h2 class="pull-left">Approval Batal Stuffing List</h2>
				</header>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: "<?= ROOT ?>npksbilling/appbtlstuf/getList?",
            data: {},
            success: function(data) {
                ...
                obj.result.forEach(function(stuff) {
                    table.append(
                        ...
                        //'<td>'+ mark +'</td>' +
                        '<td>' +
                        '<a class="btn btn-primary" href="<?= ROOT ?>npksbilling/appbtlstuf/preview/' + stuff.stuff_id + '/'+stuff.cancelled_id+'" title="Preview"><span class="glyphicon glyphicon-list-alt"></span></a>' + "&nbsp" + "&nbsp" +
                        '</td>' +
                        '</tr>'
                    );
