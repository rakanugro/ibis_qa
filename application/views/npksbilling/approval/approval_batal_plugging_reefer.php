...
<style>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="main-box clearfix">
				<header class="main-box-header clearfix">
					<h2 class="pull-left">Approval Batal Plugging Reefer List</h2>
				</header>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: "<?= ROOT ?>npksbilling/appbtlplug/getList?",
            data: {},
            success: function(data) {
                ...
                obj.result.forEach(function(plug) {
                    table.append(
                        ...
                        //'<td>'+ mark +'</td>' +
                        '<td>' +
                        '<a class="btn btn-primary" href="<?= ROOT ?>npksbilling/appbtlplug/preview/' + plug.plug_id + '/'+plug.cancelled_id+'" title="Preview"><span class="glyphicon glyphicon-list-alt"></span></a>' + "&nbsp" + "&nbsp" +
                        '</td>' +
                        '</tr>'
                    );
