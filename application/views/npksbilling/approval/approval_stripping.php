	...
	<div class="col-lg-12">
		<div class="main-box clearfix">
			<header class="main-box-header clearfix">
				<h2 class="pull-left">List - Approval Stripping</h2>
			</header>
...
<script>
	$(document).ready(function() {
		...
		$.ajax({
			type: "GET",
			url: "<?= ROOT ?>npksbilling/appbookstrip/getList?",
			data: {},
			success: function(data) {
				...
				obj.result.forEach(function(stripp) {
					table.append(
						...
						//'<td>'+ mark +'</td>' +
						'<td>' +
						'<a class="btn btn-primary" href="<?= ROOT ?>npksbilling/appbookstrip/preview/' + stripp.stripp_id + '" title="Preview"><span class="glyphicon glyphicon-list-alt"></span></a>' + "&nbsp" + "&nbsp" +
						'</td>' +
						'</tr>'
					);
