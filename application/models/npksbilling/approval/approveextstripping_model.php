<?php 
	class approveextstripping_model extends CI_Model {
	     ...
	     public function getList ()
	    {
	    	$arrData = '{
						    ...
						    "where": [
						        ...
						        ["TX_HDR_STRIPP.STRIPP_STATUS","=","2"],
						        ["TX_HDR_STRIPP.STRIPP_EXT_STATUS","=","Y"]
						    ],
						    "whereIn": [],
						    "whereIn2": [],
						    "whereNotIn": [],
