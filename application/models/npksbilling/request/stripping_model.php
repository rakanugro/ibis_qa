<?php
class stripping_model extends CI_Model
{
            ...
            "join": [
                {
                    ...
                    "field2": "TX_HDR_STRIPP.STRIPP_STATUS"
                }
            ],
            "where": [
                [
                ...
                [
                    "TX_HDR_STRIPP.STRIPP_CUST_ID",
                    "=",
                    "' . $this->session->userdata('customerid_phd') . '"
                ],
                [
                    "TX_HDR_STRIPP.STRIPP_NOTA",
                    "=",
                    "' . $id_nota . '"
                ],
				[
    ...
    public function save_stripp($data)
    {
