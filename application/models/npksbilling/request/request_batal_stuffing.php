<?php 
	class request_batal_stuffing extends CI_Model {
	    ...
	    public function getListstuffingbatal()
	    {
            ...
            "where"      : [["TM_REFF.REFF_TR_ID", "=", "10"],
                            ["TX_HDR_CANCELLED.CANCELLED_TYPE", "=", "5"],
		                    ...
		                    "JOIN"  : [
		                        {
		                            ...
		                            "field2" : "TX_DTL_STUFF.STUFF_DTL_CONT"
