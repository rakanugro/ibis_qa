<?php 
	class request_batal_fumigasi extends CI_Model {
	    ...
	    public function getListfumigasibatal()
	    {
            ...
            "where"      : [["TM_REFF.REFF_TR_ID", "=", "22"],
                            ["TX_HDR_CANCELLED.CANCELLED_TYPE", "=", "7"],
                            ["TX_HDR_FUMI.FUMI_CUST_ID","=","' . $this->session->userdata('customerid_phd') . '"],
		                    ...
		                    "JOIN"  : [
		                        {
		                            ...
		                            "field2" : "TX_DTL_FUMI.FUMI_DTL_CONT"
