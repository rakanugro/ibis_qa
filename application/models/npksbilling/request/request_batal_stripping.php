<?php 
	class request_batal_stripping extends CI_Model {
	    ...
	    public function getListstrippingbatal()
	    {
            ...
            "where"      : [["TM_REFF.REFF_TR_ID", "=", "10"],
                            ["TX_HDR_CANCELLED.CANCELLED_TYPE", "=", "6"],
	...
	public function get_nomor_request($input) {
        ...
        $arrData = '{
					    ...
					    "DETAIL": {
					        "DB": "omuster",
					        "TABLE": "TX_DTL_STRIPP",
					         "WHERE" : [["stripp_dtl_iscancelled", "=","N"]],
					        "FK": [
					            "STRIPP_HDR_ID",
					            "stripp_id"
					        ]
		                    ...
		                    "JOIN"  : [
		                        {
		                            ...
		                            "field2" : "TX_DTL_STRIPP.STRIPP_DTL_CONT"
