...
class request_batal_trucklosing extends CI_Model
{
	 ...
	 public function __construct(){
	    ...
	    public function getListtrucklosingbatal()
	    {
            ...
            "where"      : [["TM_REFF.REFF_TR_ID", "=", "22"],
                            ["TX_HDR_CANCELLED.CANCELLED_TYPE", "=", "9"],
                            ["TX_HDR_TL.TL_CUST_ID","=","' . $this->session->userdata('customerid_phd') . '"],
