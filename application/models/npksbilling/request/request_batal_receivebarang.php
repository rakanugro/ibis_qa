<?php 
	class request_batal_receivebarang extends CI_Model {
	    ...
	    public function getListreceivebarangbatal()
	    {
            ...
            [
            {
                ...
                "field2" : "TX_HDR_REC_CARGO.REC_CARGO_NO",
            ...
            "where"      : [["TM_REFF.REFF_TR_ID", "=", "22"],
                            ["TX_HDR_CANCELLED.CANCELLED_TYPE", "=", "10"],
                            ["TX_HDR_REC_CARGO.REC_CARGO_CUST_ID","=","' . $this->session->userdata('customerid_phd') . '"],
...
//end list
	...
	public function get_nomor_request($input) {
        ...
        foreach ($json['result'] as $obj) {
          $data[] = array("label"=>$obj->rec_cargo_no);
        }
	   ...
	   public function auto_generate_by_noreq($input) {
        ...
        $arrData = '{
                  ...
                  "WHERE" : [["rec_cargo_dtl_iscancelled", "=","N"]],
					        "FK": [
					            "REC_CARGO_HDR_ID",
					            "rec_cargo_id"
					        ]
