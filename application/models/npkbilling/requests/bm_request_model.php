<?php 
	class bm_request_model extends CI_Model {
			   ...
			   <soapenv:Body>
			      <ipc:indexService>
			         <indexServiceInterfaceRequest>
			            ...
			            <esbBody>
			               <request>{"action":"join","db":"omcargo","table":"TX_HDR_BM","join":[{"table":"TM_REFF","field1":"TM_REFF.REFF_ID","field2":"TX_HDR_BM.BM_STATUS"}],"where":[["TM_REFF.REFF_TR_ID","=","8"], ["BM_CUST_ID","=","'.$this->session->userdata('customerid_phd').'"], ["TX_HDR_BM.APP_ID","=","2"]],"whereIn":[],"select":[],"orderby":["BM_ID","desc"],"limit":0,"page":1,"start":1}</request>
			            </esbBody>
			            <esbSecurity>
			               <orgId></orgId>
		...
		$xml = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ipc="'.NPK_XML.'">
			...
			<soapenv:Body>
				<ipc:indexService>
					...
					<esbBody>
						<request>{"action":"viewHeaderDetail","data":["HEADER","DETAIL","SPLIT_NOTA","ALAT","FILE"],"HEADER":{"DB":"omcargo","TABLE":"TX_HDR_BM","PK":["BM_ID","'.$id.'"]},"SPLIT_NOTA":{"DB":"omcargo","TABLE":"TX_SPLIT_NOTA","FK":["REQ_NO","bm_no"]},"ALAT":{"DB":"omcargo","TABLE":"TX_EQUIPMENT","FK":["REQ_NO","bm_no"]},"DETAIL":{"DB":"omcargo","TABLE":"TX_DTL_BM","FK":["HDR_BM_ID","bm_id"]},"FILE":{"DB":"omcargo","TABLE":"TX_DOCUMENT","FK":["REQ_NO","bm_no"]}}</request>
					</esbBody>
					<esbSecurity>
						<orgId></orgId>
						<batchSourceId>?</batchSourceId>
		...
		$xml = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ipc="'.NPK_XML.'">
			...
			<soapenv:Body>
				<ipc:storeService>
					...
					<esbBody>
						<request>{"action":"sendRequest","table":"TX_HDR_BM","nota_id": 13,"id":"'.$id.'"}</request>
					</esbBody>
					<esbSecurity>
						<orgId></orgId>
						<batchSourceId>?</batchSourceId>
