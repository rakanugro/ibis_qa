...
//session_start();
class appbtltl extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('npksbilling/approval/appbataltl_model');
	...
	public function index(){
		...
		$data['title']= "Approval Batal Truck Losing";

		$this->common_loader($data,'npksbilling/approval/approval_batal_truck_losing');
	}

	public function getList()
	{
		$data = $this->appbataltl_model->getList();
		echo $data;
	}
	...
	{
		$data['menu_list'] = $this->user_model->get_menuList($this->session->userdata('group_phd'));
		$data['title'] = "Preview Approval Batal Truck Losing";
		$data['id'] = $id;
		$data['cancel_id'] = $cancel_id;
		$data['docType'] = $this->appbataltl_model->getDocType();
		$this->common_loader($data, 'npksbilling/approval/preview_batal_tl');
	}

	public function update_tl($id = null)
	{
		if ($id) {
			$data = $this->appbataltl_model->update_tl($id);
			echo $data;
		} else {
			$arr = array(
				"HEADER" => ""
	...
	{
		$data = $this->appbataltl_model->getTarif($id);
		echo json_encode($data);
	}

	public function approve($id)
	{
		$data = $this->appbataltl_model->approve($id);
		echo json_encode($data);
	}
	...
	public function reject($id)
	{
		...
		$data = $this->appbataltl_model->reject($id, $remarks);
		echo json_encode($data);
	}
