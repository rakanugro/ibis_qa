...
//session_start();
class appbtlstrip extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('npksbilling/approval/appbtlstripp_model');
	...
	public function index(){
		...
		$data['title']= "Approval Batal Stripping";

		$this->common_loader($data,'npksbilling/approval/approval_batal_Stripping');
	}

	public function getList()
	{
		$data = $this->appbtlstripp_model->getList();
		echo $data;
	}
	...
	public function preview($id,$cancel_id)
	{
		...
		$data['docType'] = $this->appbtlstripp_model->getDocType();
		$this->common_loader($data, 'npksbilling/approval/preview_approval_batal_stripping');
	}

	public function update_stripp($id = null)
	{
		if ($id) {
			$data = $this->appbtlstripp_model->update_stripp($id);
			echo $data;
		} else {
			$arr = array(
				"HEADER" => ""
	...
	{
		$data = $this->appbtlstripp_model->getTarif($id);
		echo json_encode($data);
	}

	public function approve($id)
	{
		$data = $this->appbtlstripp_model->approve($id);
		echo json_encode($data);
	}
	...
	public function reject($id)
	{
		...
		$data = $this->appbtlstripp_model->reject($id, $remarks);
		echo json_encode($data);
	}
