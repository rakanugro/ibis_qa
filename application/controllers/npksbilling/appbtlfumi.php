...
//session_start();
class appbtlfumi extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('npksbilling/approval/appbatalfumi_model');
	...
	public function index(){
		...
		$data['title']= "Approval Batal Fumigasi";

		$this->common_loader($data,'npksbilling/approval/approval_batal_fumigasi');
	}

	public function getList()
	{
		$data = $this->appbatalfumi_model->getList();
		echo $data;
	}
	...
	{
		$data['menu_list'] = $this->user_model->get_menuList($this->session->userdata('group_phd'));
		$data['title'] = "Preview Approval Batal fumi";
		$data['id'] = $id;
		$data['cancel_id'] = $cancel_id;
		$data['docType'] = $this->appbatalfumi_model->getDocType();
		$this->common_loader($data, 'npksbilling/approval/preview_batal_fumi');
	}

	public function update_fumi($id = null)
	{
		if ($id) {
			$data = $this->appbatalfumi_model->update_fumi($id);
			echo $data;
		} else {
			$arr = array(
				"HEADER" => ""
	...
	{
		$data = $this->appbatalfumi_model->getTarif($id);
		echo json_encode($data);
	}

	public function approve($id)
	{
		$data = $this->appbatalfumi_model->approve($id);
		echo json_encode($data);
	}
	...
	public function reject($id)
	{
		...
		$data = $this->appbatalfumi_model->reject($id, $remarks);
		echo json_encode($data);
	}
