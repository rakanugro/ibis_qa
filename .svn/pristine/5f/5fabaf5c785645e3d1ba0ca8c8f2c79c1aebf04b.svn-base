		...
		<div class="main-box clearfix">
			...
			<div class="main-box-body clearfix">
				...
				<div class="table-responsive">
					<table class="table table-striped table-hover transaction-list" style="width:98%; margin:0 auto; margin-bottom:50px;">
						<thead>
							<th width='30px'>No</th>
							<th width='30px'>Payment Code</th>
							<th width='100px'>Trx Date</th>
							<th width='100px'>Bank</th>
							<th width='100px'>Customer</th>
							<th width='100px'>Status Merchant</th>
							<th width='100px'>No JKM</th>
						...
						<tbody>
							...
							foreach ($payment_detail as $key => $value) {
								...
								<tr>
									...
									<td><?php echo date('d F Y', strtotime($value['trx_date'])); ?></td>
									<td><?php echo $value['bank']; ?></td>
									<td><?php echo $value['customer']; ?></td>
									<td><?php echo $value['status_merchant']; ?></td>
									<td><?php echo $value['no_jkm']; ?></td>
						...
						<tfoot id="tfoot_total" class="">
							<tr>
								...
								<td colspan="2" id="totalnya">
									<h2><b><?php echo 'Rp. ' . format_rupiah($total); ?></b></h2>
								</td>
							</tr>
						</tfoot>
