...
function getPDFNotaContainer($in_param) {
	...
	try {
		...
		$query="select TO_CHAR(DATE_PAID,'DD-MON-YYYY') AS TGL_PROSES,a.NO_FAKTUR_PAJAK, A.NO_NOTA AS KD_UPER, a.NO_REQUEST AS KD_PERMINTAAN, A.CUST_NAME NAMA_PELANGGAN, A.CUST_ADDR ALAMAT_PELANGGAN, 
		 ...
		 TO_CHAR(nvl((SELECT DISTINCT D.TOTTARIF FROM TTR_NOTA_ALL d 
		...
		if(!checkOriSQL($conn['ori']['billing'],$qrdo,$queryDO,$err)) goto Err;
		...
		$tbl = <<<EOD
			<table>
                ...
                <tr>
					...
					<td COLSPAN="1" align="left" width="10px">:</td>
                    <td COLSPAN="2" align="left" width="220px">$no_request_ol ($data[KD_PERMINTAAN])</td>
                </tr>
                <tr>
                    <td COLSPAN="7"></td>
                    <td COLSPAN="2" align="left">Tgl. Nota</td>
					<td COLSPAN="1" align="left" width="10px">:</td>
                    <td COLSPAN="2" align="left" width="170px">$data[TGL_PROSES]</td>
                </tr>    
				<tr>
                    <td COLSPAN="7"></td>
                ...
                <tr>
                    <td COLSPAN="2"></td>
                    <td COLSPAN="11" align="right"><font size="12"><b>$ket3 $data[TIPE_REQUEST] </b>  </font></td>
                </tr>
                <tr>
                <td></td>
                </tr>
		...
		$tbl .=<<<EOD
			<table>                    
                    <tr>
                        ...
                        <td width="195" colspan="3" align="right"><font size="10">Discount :</font></td>
                        <td width="120" colspan="2" align="right"><font size="10">0.00</font></td>
                    </tr>
                    <tr>
                        <td width="195" colspan="3" align="right"><font size="10">Administrasi :</font></td>
                        <td width="120" colspan="2" align="right"><font size="10">$data[ADM]</font></td>
                    </tr>
                    <tr>
                        <td width="195" colspan="3" align="right"><font size="10">Dasar Pengenaan Pajak :</font></td>
                        <td width="120" colspan="2" align="right"><font size="10">$data[TOTAL]</font></td>
                    </tr>
                    <tr>
                        <td width="195" colspan="3" align="right"><font size="10">Jumlah PPN :</font></td>
                        <td width="120" colspan="2" align="right"><font size="10">$data[PPN]</font></td>
                    </tr>
                    <tr>
                        <td width="195" colspan="3" align="right"><font size="10">Jumlah PPN Subsidi :</font></td>
                        <td width="120" colspan="2" align="right"><font size="10">0.00</font></td>
                    </tr>
                    <tr>
                        <td width="195" colspan="3" align="right"><font size="10">Jumlah Dibayar :</font></td>
