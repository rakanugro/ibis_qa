		...
		if ($row = oci_fetch_array($query_header, OCI_ASSOC))
		{
			...
			<table align="center"border="0" cellspacing="0" cellpadding="0">
				<tr> 
				  ...
				  <td width="180"><div align="left">: '.$row[NM_AGEN].'</div></td>
				...
				<tr> 
				  ...
				  <td width="180"><div align="left">: '.$row[NO_ACCOUNT].' </div></td>
				...
				<tr> 
				  ...
				  <td width="180"><div align="left">: '.$row[NO_NPWP].'</div></td>
			...
			$header.='
				...
				<tr> 
				  ...
				  <td width="180"><div align="left">: '.$row[ALMT_AGEN].' </div></td>
