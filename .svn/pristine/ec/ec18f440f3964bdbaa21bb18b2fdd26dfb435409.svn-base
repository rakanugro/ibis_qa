							...
							<div class="main-box-body clearfix">
								<table width="100%">
									<tr style="height: 30px;">
										...
										<td width="5%">:</td>
										<td width="75%"><?php echo $bl_number?></td>
									</tr>
									<tr style="height: 30px;">
										<td width="25%">Jenis Curah</td>
										<td width="5%">:</td>
										<td width="75%"></td>
									</tr>
									<tr style="height: 30px;">
									...
									<tr style="height: 30px;">
										...
										<td width="5%">:</td>
										<td width="75%"><?php echo $quantity?></td>
									</tr>
									<tr style="height: 30px;">
									...
									<tr style="height: 30px;">
										...
										<td width="5%">:</td>
										<td width="75%"><?php echo $vessel?></td>
									</tr>
									<tr style="height: 30px;">
										<td width="25%">PBM</td>
										<td width="5%">:</td>
									...
									<tr style="height: 30px;">
										<td width="25%">Jenis Perdagangan</td>
										<td width="5%">:</td>
										<td width="75%"></td>
									</tr>
								</table>
					...
					<div class="col-lg-12">
						<div class="main-box">
							...
							<div class="main-box-body clearfix">
								<table width="100%">
									<tr style="height: 30px;">
										<td colspan="4">Gate In</td>
									</tr>
									<tr style="height: 30px;">
										<td width="10%">&nbsp;</td>
										<td width="13%">Gate In Date</td>
										<td width="5%">:</td>
										<td width="62%"></td>
									</tr>
									<tr style="height: 30px;">
										<td colspan="4">Placement</td>
									</tr>
									<tr style="height: 30px;">
										<td width="10%">&nbsp;</td>
										<td width="13%">Placement Date</td>
										<td width="5%">:</td>
										<td width="62%"></td>
									</tr>
									<tr style="height: 30px;">
										<td width="10%">&nbsp;</td>
										<td width="13%">Location Gudang</td>
										<td width="5%">:</td>
										<td width="62%"></td>
									</tr>
									<tr style="height: 30px;">
										<td colspan="4">Stavedoring (Muat)</td>
									</tr>
									<tr style="height: 30px;">
										<td width="10%">&nbsp;</td>
										<td width="13%">Stavedoring Date</td>
										<td width="5%">:</td>
										<td width="62%"></td>
									</tr>
									<tr style="height: 30px;">
										<td width="10%">&nbsp;</td>
										<td width="13%">Location Dermaga</td>
										<td width="5%">:</td>
										<td width="62%"></td>
									</tr>
									<tr style="height: 30px;">
										<td width="10%">&nbsp;</td>
										<td width="13%">To Vessel</td>
										<td width="5%">:</td>
										<td width="62%"></td>
									</tr>
									<tr style="height: 30px;">
										<td colspan="4">Stavedoring (Bongkar)</td>
									</tr>
									<tr style="height: 30px;">
										<td width="10%">&nbsp;</td>
										<td width="13%">Stavedoring Date</td>
