							...
							<div class="main-box">
								...
								<div class="form-group">
									...
									<div class="form-group col-xs-12">
										...
										<input type="text" class="form-control" id="no_container_eservice" name="no_container_eservice"  title="Masukkan data customer" size="8">
									</div>
									<div class="form-group col-xs-4">
										<label for="exampleAutocomplete">No Container<font color="red">*</font></label>
										<input type="text" class="form-control" id="no_container" name="no_container" title="Masukkan data customer" size="8" value="<?=$request_data[0]['NO_CONTAINER']?>"readonly>
									</div>
									<div class="form-group col-xs-4">
