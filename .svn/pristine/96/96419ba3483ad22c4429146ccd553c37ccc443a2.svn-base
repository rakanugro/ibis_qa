								...
								<div class="box-body">
									...
									<div class="form-group">
										<div class="box-body">
											...
											<div class="row">
												<div class="col-xs-5">
													<input type="text" name="BILLER_REQUEST_ID" id="BILLER_REQUEST_ID" class="form-control" placeholder="No Request">
												</div>
											</div>
										</div>
									</div>
	...
	function loaddata(bulan, tahun) {
		...
		$('#tableRupa').DataTable({
			...
			"columns": [
				...
				{ "data": "VESSEL_NAME" },
				{ "data": "INTERFACE_HEADER_ATTRIBUTE9" },
				{ "data": "JENIS" },
				{ "data": "TRX_DATE" },
				{ "data": "AMOUNT" },
				{ "data": "STATUS_LUNAS" },
