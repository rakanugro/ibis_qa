...
$(document).ready(function() {
	...
	$( "#truck_id_auto" ).autocomplete({
		
		minLength: 4,
		source: function(request, response) {
			$.getJSON("<?=ROOT?>truck_container/search_cancel",{<?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo
								$this->security->get_csrf_hash(); ?>' ,  truck_id: $( "#truck_id_auto" ).val() ,  no_request: $( "#search_eservice" ).val(), port: $("#port").val()}, response);

			},
		focus: function( event, ui )
		{
			$( "#no_container_eservice" ).val( ui.item.TRUCK_ID);
			return false;
		},
	...
	}).data( "uiAutocomplete" )._renderItem = function( ul, item )
	{
		...
		.append( "<a align='center'><p class='repo-language'>" + item.TRUCK_ID + "</p></a>")
		.appendTo( ul );
	...
	var url="<?=ROOT?>truck_container/cancel_tca_association_m2m";
	$.blockUI();
	$.post(url,{terminal:terminal,eservice:eservice,no_request:no_request,truck_id:truck_id,'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'},
	...
	function(data) {
		...
		{ 	
			...
			else
			{
				...
				window.location = "<?=ROOT?>truck_container/cancel_tca_m2m";
...
<script src="<?=JSQ?>jquery-ui.min.js"></script>					
				...
				<div class="row">		
						<div class="col-lg-8"  id='eservice'>
							<div class="main-box">
								<header class="main-box-header clearfix">
									<h2>Eservice</h2>
								</header>
								...
								<div class="form-group">
									...
									<div class="form-group col-xs-12">
										...
										<input type="text" class="form-control" id="search_eservice" name="search_eservice"  class="no_request" title="Masukkan data customer" size="8">
									</div>
									<div class="form-group col-xs-12">
										<label for="exampleAutocomplete">Truck ID<font color="red">*</font></label>
										<input type="text" class="form-control" id="truck_id_auto" name="truck_id_auto"  title="Masukkan data customer" size="8">
									</div>
									<div class="form-group col-xs-6">
										<label for="exampleAutocomplete">Truck ID<font color="red">*</font></label>
										<input type="text" class="form-control" id="truck_id" name="truck_id"  title="Masukkan data customer" size="8" readonly>
									</div>
									<div class="form-group col-xs-6">
										<label for="exampleAutocomplete">Truck Number<font color="red">*</font></label>
										<input type="text" class="form-control" id="truck_number" name="truck_number" title="Masukkan data customer" size="8" readonly>
										<input type="hidden" class="form-control" id="pin_number" name="pin_number"  title="Masukkan data customer" size="8" value="<?=$request_data[0]['PIN_NUMBER']?>" readonly>
									</div>									
									<div>
							...
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<div class="form-group">
										...
										<div class="form-group col-xs-12">
											<label for="exampleAutocomplete">No Request<font color="red">*</font></label>
											<input type="text" class="form-control" id="search_noneservice" name="search_noneservice"  class="no_request" title="Masukkan data customer" size="8">
										</div>
										<div class="form-group col-xs-12">
											<label for="exampleAutocomplete">No Container<font color="red">*</font></label>
											<input type="text" class="form-control" id="no_container_noneservice" name="no_container_noneservice"  title="Masukkan data customer" size="8">
										</div>
										...
										<div class="form-group col-xs-4">
											<label for="exampleAutocomplete">Truck ID<font color="red">*</font></label>
											<input type="text" class="form-control" id="truck_id_" name="truck_id_" title="Masukkan data customer" size="8" readonly>
										</div>
										<div class="form-group col-xs-4">
											<label for="exampleAutocomplete">Truck Number<font color="red">*</font></label>
											<input type="text" class="form-control" id="truck_number_" name="truck_number_"  title="Masukkan data customer" size="8" readonly>
											<input type="hidden" class="form-control" id="pin_number_" name="pin_number_"  title="Masukkan data customer" size="8" readonly>	
										</div>
										<div>
