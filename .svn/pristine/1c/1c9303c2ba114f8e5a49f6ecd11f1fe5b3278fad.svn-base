															...
															<div class="main-box-body clearfix">
																...
																<div class="row">
																	<div class="form-group example-twitter-oss col-md-5">
																		...
																		<input type='hidden' id='simop_customer_id' name='simop_customer_id' value="<?php echo $register['BILLING_CUSTOMER_ID']?>" />
																		<input type='hidden' id='simop_customer_id_nosync' name='simop_customer_id_nosync' value="<?php echo $register['BILLING_CUSTOMER_ID']?>" />
																		<input type='hidden' id='npwp_id' name='npwp'/>
																		<input type='hidden' id='branch_id' name='branch_id' value="<?php echo $register['BRANCH_ID']?>"/>
	...
	function initSimopName(){
		$('#simop_customer_name').typeahead({
			...
			template: [
				...
				'<p class="repo-name">Cabang : {{branch_id}}</p>'
			].join(''),
			engine: Hogan
