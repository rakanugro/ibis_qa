...
function oriDb() 
{
	...
	$conn['ptp_kapal'] = oci_connect('kapal_prod', '$Prod_k4p4lpass', 'dr-scan.indonesiaport.co.id:1521/PELDBJAL');//prod
...
{
	//setup oracle db connection
	$conn['ilcs_recon'] = oci_connect('RECONUSER', '##RECON##', '172.16.254.231:1521/oradb');
