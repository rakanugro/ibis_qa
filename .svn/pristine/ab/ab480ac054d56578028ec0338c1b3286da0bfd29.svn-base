...
function syncData($in_param) {
	...
	try {
		...
		$sql_update_customer_data = "update mst_pbm_skapal set insert_update_flag = 'P' where no_account_pbm = '$id' and insert_update_flag is null";
		if(!checkOriSQL($conn['ori']['ibis'],$sql_update_customer_data,$query_update_customer_data,$err)) goto Err;
		...
		while($row = oci_fetch_array($query_get_customer_data, OCI_ASSOC))
		{
			...
			$NAMA_PERUSAHAAN = str_replace(array("'"),array("''"),$NAMA_PERUSAHAAN);
			$NAMA_PERUSAHAAN_FIX= $row[NAMA_PERUSAHAAN_FIX]!="" ? $row[NAMA_PERUSAHAAN_FIX] : "";
			$NAMA_PERUSAHAAN_FIX = str_replace(array("'"),array("''"),$NAMA_PERUSAHAAN_FIX);
			$NAMA_PERUSAHAAN_FAKTUR_PAJAK= $row[NAMA_PERUSAHAAN_FAKTUR_PAJAK]!="" ? $row[NAMA_PERUSAHAAN_FAKTUR_PAJAK] : "";
			$NAMA_PERUSAHAAN_FAKTUR_PAJAK = str_replace(array("'"),array("''"),$NAMA_PERUSAHAAN_FAKTUR_PAJAK);
			...
			//loop org id
			$org_id_arr = array("1824","1825","1826","1822","1823");
			...
			foreach ($org_id_arr as $ORG_ID)
			{
				...
				else
				{
					...
					{						
						...
						}//end update to master pelanggan
							...
							while($row3 = oci_fetch_array($query_get_customer_data3, OCI_ASSOC))
							{
								...
								if($row_jumlah_agen_kapal[JUMLAH_PELANGGAN_KAPAL]==0)
								{
									if($KD_AGEN=="")
									{
										...
										$KD_AGEN2 = $row_new_kd_agen[NEW_KD_AGEN];
									}
						...
						}//end update to mst_agen
						
						{//update ke master pbm
							$sql_get_customer_data3 = "select * from mst_pbm_skapal where no_account_pbm = '$id' and insert_update_flag = 'P' order by date_insert asc";
							...
							while($row3 = oci_fetch_array($query_get_customer_data3, OCI_ASSOC))
							{
								$KD_PBM	= $row3[KD_PBM]!="" ? $row3[KD_PBM] : "";
								$NM_PBM	= $row3[NM_PBM]!="" ? $row3[NM_PBM] : "";
								$ALMT_PBM	= $row3[ALMT_PBM]!="" ? $row3[ALMT_PBM] : "";
								$NO_TELP	= $row3[NO_TELP]!="" ? $row3[NO_TELP] : "";
								$ALMT_AGEN	= $row3[ALMT_AGEN]!="" ? $row3[ALMT_AGEN] : "";
								$NO_ACCOUNT_PBM	= $row3[NO_ACCOUNT_PBM]!="" ? $row3[NO_ACCOUNT_PBM] : "";
								$KD_PPN_PBM	= $row3[KD_PPN_PBM]!="" ? $row3[KD_PPN_PBM] : "";
								$NO_NPWP_PBM	= $row3[NO_NPWP_PBM]!="" ? $row3[NO_NPWP_PBM] : "";
								$KD_GUDANG1	= $row3[KD_GUDANG1]!="" ? $row3[KD_GUDANG1] : "";
								$KD_GUDANG2	= $row3[KD_GUDANG2]!="" ? $row3[KD_GUDANG2] : "";
								$KD_CABANG	= $row3[KD_CABANG]!="" ? $row3[KD_CABANG] : "";
								$NO_TLP2	= $row3[NO_TLP2]!="" ? $row3[NO_TLP2] : "";
								$NO_TLP3	= $row3[NO_TLP3]!="" ? $row3[NO_TLP3] : "";
								$KD_PPN_AGEN	= $row3[KD_PPN_AGEN]!="" ? $row3[KD_PPN_AGEN] : "";
								...
								$ALAMAT_EMAIL2	= $row3[ALAMAT_EMAIL2]!="" ? $row3[ALAMAT_EMAIL2] : "";
								$CATATAN	= $row3[CATATAN]!="" ? $row3[CATATAN] : "";
								$NO_SIUPBM	= $row3[NO_SIUPBM]!="" ? $row3[NO_SIUPBM] : "";
								$TGL_TERBIT_SIUPBM	= $row3[TGL_TERBIT_SIUPBM]!="" ? $row3[TGL_TERBIT_SIUPBM] : "";
								$TGL_BERLAKU_SIUPBM	= $row3[TGL_BERLAKU_SIUPBM]!="" ? $row3[TGL_BERLAKU_SIUPBM] : "";
								$NO_SIOPSUS	= $row3[NO_SIOPSUS]!="" ? $row3[NO_SIOPSUS] : "";
								$TGL_TERBIT_SIOPSUS	= $row3[TGL_TERBIT_SIOPSUS]!="" ? $row3[TGL_TERBIT_SIOPSUS] : "";
								$TGL_BERLAKU_SIOPSUS	= $row3[TGL_BERLAKU_SIOPSUS]!="" ? $row3[TGL_BERLAKU_SIOPSUS] : "";
								$PENANGGUNG_JAWAB	= $row3[PENANGGUNG_JAWAB]!="" ? $row3[PENANGGUNG_JAWAB] : "";
								...
								{
									//if($set_agen!="") $set_agen .= ",";		
									//$set_agen .= "KD_PBM = '$KD_PBM'";
								}
								if($NM_PBM!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "NM_PBM = '$NM_PBM'";
								}
								if($ALMT_PBM!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "ALMT_PBM = '$ALMT_PBM'";
								}
								if($NO_TELP!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "NO_TELP = '$NO_TELP'";
								}
								if($NO_ACCOUNT_PBM!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "NO_ACCOUNT_PBM = '$NO_ACCOUNT_PBM'";
								}
								if($KD_PPN_PBM!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "KD_PPN_PBM = '$KD_PPN_PBM'";
								}
								if($NO_NPWP_PBM!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "NO_NPWP_PBM = '$NO_NPWP_PBM'";
								}
								if($KD_GUDANG1!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "KD_GUDANG1 = '$KD_GUDANG1'";
								}
								if($KD_GUDANG2!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "KD_GUDANG2 = '$KD_GUDANG2'";
								}
								if($KD_CABANG!="")
								{
									if($set_agen!="") $set_agen .= ",";		
								...
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "NO_SIUPBM = '$NO_SIUPBM'";
								}
								if($TGL_TERBIT_SIUPBM!="")
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "TGL_TERBIT_SIUPBM = '$TGL_TERBIT_SIUPBM'";
								}
								if(TGL_BERLAKU_SIUPBM)
								{
									if($set_agen!="") $set_agen .= ",";		
									$set_agen .= "TGL_BERLAKU_SIUPBM = '$TGL_BERLAKU_SIUPBM'";
								}
								if($NO_SIOPSUS!="")
								{
									if($set_agen!="") $set_agen .= ",";		
								...
								if($KD_PBM=="")
									$sql_get_jumlah_pbm_kapal = "select count(*) as jumlah_pelanggan_kapal from mst_pbm where no_account_pbm = '$id'";
								else 
									$sql_get_jumlah_pbm_kapal = "select count(*) as jumlah_pelanggan_kapal from mst_pbm where kd_pbm = '$KD_PBM'";

								//QUERY
								if(!checkOriSQL($conn['ori']['kapal'],$sql_get_jumlah_pbm_kapal,$query_get_jumlah_pbm_kapal,$err)) goto Err;

								$row_jumlah_pbm_kapal = oci_fetch_array($query_get_jumlah_pbm_kapal, OCI_ASSOC);
						
								//if(($INSERT_UPDATE_FLAG=="I"||$row_jumlah_pbm_kapal[JUMLAH_PELANGGAN_KAPAL]==0)&&!$already_insert_agen)
								if($row_jumlah_pbm_kapal[JUMLAH_PELANGGAN_KAPAL]==0)
								{
									if($KD_PBM=="")
									{
										$sql_get_new_kd_pbm = "select MAX(to_number(KD_PBM))+1 as new_kd_pbm from mst_pbm WHERE F_IS_NUMBER(KD_PBM) = 1";
										
										//QUERY
										if(!checkOriSQL($conn['ori']['kapal'],$sql_get_new_kd_pbm,$query_get_new_kd_pbm,$err)) goto Err;

										$row_new_kd_pbm = oci_fetch_array($query_get_new_kd_pbm, OCI_ASSOC);
									
										$KD_PBM2 = str_pad($row_new_kd_pbm[NEW_KD_PBM], 4, "0", STR_PAD_LEFT);
									}
									...
									{
										$sql_update_kapal = "INSERT INTO MST_PBM (
															   KD_PBM, 
															   NM_PBM, 
															   ALMT_PBM, 
															   NO_TELP, 
								...
								else
								{
									if($KD_PBM=="")
									{
										$sql_update_kapal = "UPDATE mst_pbm set $set_agen where no_account_pbm = '$id'";
									}
									else 
									{
										$sql_update_kapal = "UPDATE mst_pbm set $set_agen where kd_pbm = '$KD_PBM'";
									}								
						...
						}//end update to mst_pbm
							
						if($KD_CABANG_OLD=="1582")
						{//update rekening cms = khusus jai 
							//update rekening cms 
						...
						{//update ke rekening autocollection = khusus ptp 
						...
						$sql_update_customer_data2 = "update mst_pbm_skapal set insert_update_flag = 'S' 
														where no_account_pbm = '$id' and insert_update_flag = 'P'";
						if(!checkOriSQLAutoCommit($conn['ori']['ibis'],$sql_update_customer_data2,$query_update_customer_data2,$err)) goto Err;
					...
					else 
					{
						...
						$sql_update_customer_data2 = "update mst_pbm_skapal set insert_update_flag = 'F' 
														where no_account_pbm = '$id' and insert_update_flag = 'P'";
						if(!checkOriSQLAutoCommit($conn['ori']['ibis'],$sql_update_customer_data2,$query_update_customer_data2,$err)) goto Err;
