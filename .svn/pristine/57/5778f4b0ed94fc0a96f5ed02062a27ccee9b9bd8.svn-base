...
function oriDb() 
{
	...
	$conn['ibis'] = oci_connect('IBIS', 'ibis321', '10.10.33.25:1521/ORCL');
...
{
	//setup oracle db connection
	//$conn['kapal'] = oci_connect('KAPAL_PROD', 'KAPAL_PROD', '10.10.12.218:1521/PELDB'); //dev
	$conn['kapal'] = oci_connect('kapal_prod', '$Prod_k4p4lpass', '10.10.30.22:1521/PELDBJAL');//prod
	return $conn;
}
