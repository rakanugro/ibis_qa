...
<script src="<?=JSQ?>jquery-ui.min.js"></script>
								...
								<div class="col-lg-12">
									<div class="main-box">
										<header class="main-box-header clearfix">
											<h2>Create New</h2>
                                            <i>(Please click here for new loading cancel request)</i>
										</header>
										
										<div class="main-box-body clearfix">
											<form class="form-inline" role="form" action="<?=ROOT?>container_alihkapal/add_alihkapal">
												<button type="submit" id="submit_form" onclick="" class="btn btn-success">Create</button>
											</form>
											 <?php 
												//$attributes = array('role'=>'form','class'=>'form-inline');
												//echo form_open(ROOT.'container_alihkapal/add_alihkapal',$attributes);
					...
					<div class="row" id="tabledata">
						<div class="col-lg-12">
							<div class="main-box clearfix">
								<header class="main-box-header clearfix">
									<h2 class="pull-left">Loading Cancel Booking List</h2>
