...
!function(factory) {
    ...
    $.mask = {
        ...
        caret: function(begin, end) {
			console.log('caret start: begin '+begin+' end '+end);
            var range;
			...
			,console.log('caret finish: begin '+begin+' end '+end);
        },
        unmask: function() {
			...
			$.each(mask.split(""), function(i, c) {
                ...
                function tryFireCompleted() {
                    ...
                    if (settings.completed) {
						console.log('fire '+firstNonMaskPos+'/'+lastRequiredNonMaskPos);
                ...
                function getPlaceholder(i) {
					//console.log('getplaceholder : '+i);
                    return settings.placeholder.charAt(i < settings.placeholder.length ? i : 0);
                }
                function seekNext(pos) {
					console.log('seeknext');
                    for (;++pos < len && !tests[pos]; ) {console.log(pos);}
                    return pos;
                }
                function seekPrev(pos) {
					console.log('seekprev');
                    for (;--pos >= 0 && !tests[pos]; ) {console.log(pos);}
                    return pos;
                }
                function shiftL(begin, end) {
					console.log('shiftL'+begin+'/'+end);
                    var i, j;
                    if (!(0 > begin)) {
                ...
                function shiftR(pos) {
					console.log('shiftR'+pos.begin+'/'+pos.end);
                    var i, c, j, t;
