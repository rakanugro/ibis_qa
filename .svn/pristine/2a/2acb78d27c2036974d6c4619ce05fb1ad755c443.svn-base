	                	...
	                	<div class="box-body">
							<div class="main-box-body clearfix">
								<div class="tabs-wrapper"  id="tabs">
									<ul class="nav nav-tabs">
										<li class="active" ><a href="#tab-home1" data-toggle="tab">General</a></li>
									...
									<div class="tab-content">
										<div class="tab-pane fade " id="tab-home1">
											<form action="#" class="form-horizontal" id="formUpdateEntity" enctype="multipart/form-data" >
												...
												<div class="modal-footer">
										           <button  type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#allert_entity_update">Update</button>
								                   <button type="button" class="btn btn-sm" style="background-color: #e0dcdc;" data-dismiss="modal">Tutup</button>
								                </div>
										...
										<div class="tab-pane" id="tab-faktur1">
											<table id="table-example" class="table table-hover">
												...
												<div class="modal-footer">
										           <button  type="button" class="btn btn-primary btn-sm" onclick="check_validation2()">Save</button>
								                   <button type="button" class="btn btn-sm" style="background-color: #e0dcdc;" data-dismiss="modal">Tutup</button>
								                </div>
												<table id="table-example" class="table table-hover">
																	<thead>
											...
											<form action="javascript:void(0);" class="form-horizontal" id="formAddMaterai" >
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text"  step="any" name="INV_EMATERAI_MIN_AMOUNT1" id="INV_EMATERAI_MIN_AMOUNT1" class="form-control" placeholder="Minimal Total Pembayaran">
															</div>
														</div>
													</div>
												</div>
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text"  step="any" name="INV_EMATERAI_NOMINAL1" id="INV_EMATERAI_NOMINAL1" class="form-control" placeholder="Nominal Materai">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-3">
																<select class="form-control select2" style="width: 100%;" name="" id="INV_EMATERAI_STATUS1">
																	<option value="Active">Active</option>
																	<option value="Not Active">Not Active</option>
																</select>
															</div>
												...
												<div class="modal-footer">
										           <button  type="button" class="btn btn-primary btn-sm" onclick="check_validation1()">Save</button>
								                   <button type="button" class="btn btn-sm" style="background-color: #e0dcdc;" data-dismiss="modal">Tutup</button>
								                </div>
												<div class="row">
												<div class="clo-lg-12">
																...
																<table id="table-materai" class="table table-hover">
																	<thead>
																		<tr>
																			...
																			<th>Expired Date</th>
																			<th>Nominal Materai</th>
																			<th>Minimal Total Pembayaran</th>
																			<th>Status</th>
																			<th></th>
																		</tr>
																	</thead>
	        ...
	        <div style="background-color:#B22222;" class="modal-header">
	        	...
	        	<div class="modal-body">
					<form id="form1">
								...
								<form class="form-horizontal">
									...
									<div class="box-body">
										<div class="form-group">
											...
											<div class="row">
												<div class="col-xs-5">
													<input type="text"  step="any" name="INV_EMATERAI_MIN_AMOUNT2" id="INV_EMATERAI_MIN_AMOUNT2" class="form-control currency " placeholder="Minimal Total Pembayaran">
												</div>
											</div>
										</div>
									</div>
									<div class="box-body">
										<div class="form-group">
											...
											<div class="row">
												<div class="col-xs-5">
													<input type="text"  step="any" name="INV_EMATERAI_NOMINAL2" id="INV_EMATERAI_NOMINAL2" class="form-control currency " placeholder="Nominal Materai">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="box-body">
										<div class="form-group">
											...
											<div class="row">
												<div class="col-xs-3">
													<select class="form-control select2" style="width: 100%;" name="INV_EMATERAI_STATUS2" id="INV_EMATERAI_STATUS2">
														<option value="Active">Active</option>
														<option value="Not Active">Not Active</option>
													</select>
												</div>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#allert_materai_edit">Update</button>
							<button type="button" class="btn btn-sm" style="background-color: #e0dcdc;" data-dismiss="modal">Tutup</button>
						</div>
					</div>
				</form>
	        ...
	        <div style="background-color:#B22222;" class="modal-header">
	        	...
	        	<div class="modal-body">
					<form id="form1">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#allert_faktur_edit">Update</button>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		var input1 = document.getElementById('INV_EMATERAI_NOMINAL1');
		input1.addEventListener('keyup', function(e)
		{
			input1.value = format_number(this.value);
		});
		
		var input2 = document.getElementById('INV_EMATERAI_MIN_AMOUNT1');
		input2.addEventListener('keyup', function(e)
		{
			input2.value = format_number(this.value);
		});
		
		var input3 = document.getElementById('INV_EMATERAI_NOMINAL2');
		input3.addEventListener('keyup', function(e)
		{
			input3.value = format_number(this.value);
		});
		
		var input4 = document.getElementById('INV_EMATERAI_MIN_AMOUNT2');
...
function check_validation1() {
  ...
  var INV_EMATERAI_NOMINAL1 = document.getElementById('INV_EMATERAI_NOMINAL1').value;
  var INV_EMATERAI_MIN_AMOUNT1 = document.getElementById('INV_EMATERAI_MIN_AMOUNT1').value;
  ...
  || INV_EMATERAI_NOMINAL1 == "" || INV_EMATERAI_MIN_AMOUNT1 == "") {
    //alert('gak boleh kosong cok');
    $("#blank_form").modal();
  } else {
    //alert(kode_entity);
 ...
 //                    ],
	...
	tableEntity = $('#myTable').DataTable({
			...
			"ajax": {
                ...
                <?php
                if($this->session->userdata('role_type') == 'Super Admin') {
                  echo "d.INV_ENTITY_CODE = $(\"#INV_ENTITY_CODE2\").val();";
                } else {
                  $entity_code = $this->session->userdata('entity_code');
                  echo "d.INV_ENTITY_CODE = '$entity_code';";
                }
                ?>
...
?>
    ...
    if($this->session->userdata('role_type') == 'Super Admin') {
      ...
      ?>
      var INV_ENTITY_CODE 	= '<?php echo $this->session->userdata('entity_code');?>';
      <?php
    }
    ?>
...
/*
	...
	function savematerai1()
	{
		...
		var INV_EMATERAI_NOMINAL 	= parseInt($("#INV_EMATERAI_NOMINAL1").val().replace(/\D/g,''));
		var INV_EMATERAI_MIN_AMOUNT = parseInt($("#INV_EMATERAI_MIN_AMOUNT1").val().replace(/\D/g,''));
		var INV_EMATERAI_EFECTIVE1	= $("#INV_EMATERAI_EFECTIVE1").val();
		var INV_EMATERAI_END1 		= $("#INV_EMATERAI_END1").val();
		var INV_ENTITY_CODE 		= $("#INV_ENTITY_CODEEDIT").val();
		var INV_EMATERAI_STATUS 	= $("#INV_EMATERAI_STATUS1").val();
		...
		$.post( path, {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
			...
			INV_EMATERAI_EFECTIVE:INV_EMATERAI_EFECTIVE,
			INV_EMATERAI_END:INV_EMATERAI_END,
			INV_EMATERAI_STATUS:INV_EMATERAI_STATUS,
			INV_ENTITY_ID : entityID
		}).done(function( data ) {
			try {
					var result = JSON.parse(data);
	...
	function updatematerai()
	{
		...
		var INV_EMATERAI_NOMINAL 	= parseInt($("#INV_EMATERAI_NOMINAL2").val().replace(/\D/g,''));
		var INV_EMATERAI_MIN_AMOUNT = parseInt($("#INV_EMATERAI_MIN_AMOUNT2").val().replace(/\D/g,''));
		...
		var INV_EMATERAI_STATUS 	= $("#INV_EMATERAI_STATUS2").val();
		...
		INV_ENTITY_ID:entityID
			...
			try {
					...
					|| INV_EMATERAI_NOMINAL == "" || INV_EMATERAI_MIN_AMOUNT == ""){
						$("#blank_form").modal();
					}
					else{
						if (result.status == "success") {
	...
	function editmaterai($id)
	{
			...
			,INV_EMATERAI_ID:INV_EMATERAI_ID
				...
				$('[name="INV_EMATERAI_MIN_AMOUNT2"]').val(addCommas(data2.INV_EMATERAI_MIN_AMOUNT));
				$('[name="INV_EMATERAI_NOMINAL2"]').val(addCommas(data2.INV_EMATERAI_NOMINAL));
				...
				$('[name="INV_EMATERAI_STATUS2"]').val(data2.INV_EMATERAI_STATUS);
		...
		$.post( path, {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
			...
			for(i=0; i<Object.keys(data2).length; i++){
				...
				html += '<tr>'+
						...
						'<td><button type="button" id="" name="" onclick="editfaktur(\''+data2[i].INV_FAKTUR_ID+'\')" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#update-faktur"><i class="fa fa-pencil-square"></i></button></td>'+
						'</tr>';
			}
